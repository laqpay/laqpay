...
```
» go run cmd/laqpay/laqpay.go --help
...
Usage:
  ...
  -peerlist-url string
    	with -download-peerlist=true, download a peers.txt file from this url (default "https://downloads.laqpay.net/blockchain/peers.txt")
  -port int
...
The URL of the remote peer list bootstrap file. Defaults to https://downloads.laqpay.net/blockchain/peers.txt.
