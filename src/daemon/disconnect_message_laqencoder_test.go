...
func testLaqencoderDisconnectMessage(t *testing.T, obj *DisconnectMessage) {
...
func TestLaqencoderDisconnectMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderDisconnectMessage(t, tc.obj)
		})
	}
}
...
func testLaqencoderDisconnectMessageDecodeErrors(t *testing.T, k int, tag string, obj *DisconnectMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderDisconnectMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderDisconnectMessageDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderDisconnectMessageDecodeErrors(t, i, "full", fullObj)
	}
}
