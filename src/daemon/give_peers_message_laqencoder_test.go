...
func testLaqencoderGivePeersMessage(t *testing.T, obj *GivePeersMessage) {
...
func TestLaqencoderGivePeersMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderGivePeersMessage(t, tc.obj)
		})
	}
}
...
func testLaqencoderGivePeersMessageDecodeErrors(t *testing.T, k int, tag string, obj *GivePeersMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderGivePeersMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderGivePeersMessageDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderGivePeersMessageDecodeErrors(t, i, "full", fullObj)
	}
}
