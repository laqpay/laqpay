...
func testLaqencoderIntroductionMessage(t *testing.T, obj *IntroductionMessage) {
...
func TestLaqencoderIntroductionMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderIntroductionMessage(t, tc.obj)
		})
	}
}
...
func testLaqencoderIntroductionMessageDecodeErrors(t *testing.T, k int, tag string, obj *IntroductionMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderIntroductionMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderIntroductionMessageDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderIntroductionMessageDecodeErrors(t, i, "full", fullObj)
	}
}
