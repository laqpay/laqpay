...
func testLaqencoderGiveBlocksMessage(t *testing.T, obj *GiveBlocksMessage) {
...
func TestLaqencoderGiveBlocksMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderGiveBlocksMessage(t, tc.obj)
		})
	}
}
...
func testLaqencoderGiveBlocksMessageDecodeErrors(t *testing.T, k int, tag string, obj *GiveBlocksMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderGiveBlocksMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderGiveBlocksMessageDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderGiveBlocksMessageDecodeErrors(t, i, "full", fullObj)
	}
}
