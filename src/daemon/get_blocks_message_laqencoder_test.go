...
func testLaqencoderGetBlocksMessage(t *testing.T, obj *GetBlocksMessage) {
...
func TestLaqencoderGetBlocksMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderGetBlocksMessage(t, tc.obj)
		})
	}
}
...
func testLaqencoderGetBlocksMessageDecodeErrors(t *testing.T, k int, tag string, obj *GetBlocksMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderGetBlocksMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderGetBlocksMessageDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderGetBlocksMessageDecodeErrors(t, i, "full", fullObj)
	}
}
