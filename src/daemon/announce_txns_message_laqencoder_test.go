...
func testLaqencoderAnnounceTxnsMessage(t *testing.T, obj *AnnounceTxnsMessage) {
...
func TestLaqencoderAnnounceTxnsMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderAnnounceTxnsMessage(t, tc.obj)
		})
	}
}
...
func testLaqencoderAnnounceTxnsMessageDecodeErrors(t *testing.T, k int, tag string, obj *AnnounceTxnsMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderAnnounceTxnsMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderAnnounceTxnsMessageDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderAnnounceTxnsMessageDecodeErrors(t, i, "full", fullObj)
	}
}
