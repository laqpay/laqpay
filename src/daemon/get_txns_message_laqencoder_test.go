...
func testLaqencoderGetTxnsMessage(t *testing.T, obj *GetTxnsMessage) {
...
func TestLaqencoderGetTxnsMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderGetTxnsMessage(t, tc.obj)
		})
	}
}
...
func testLaqencoderGetTxnsMessageDecodeErrors(t *testing.T, k int, tag string, obj *GetTxnsMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderGetTxnsMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderGetTxnsMessageDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderGetTxnsMessageDecodeErrors(t, i, "full", fullObj)
	}
}
