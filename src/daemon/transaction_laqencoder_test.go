...
func newEmptyTransactionForEncodeTest() *coin.Transaction {
	var obj coin.Transaction
	return &obj
}

func newRandomTransactionForEncodeTest(t *testing.T, rand *mathrand.Rand) *coin.Transaction {
	var obj coin.Transaction
...
func newRandomZeroLenTransactionForEncodeTest(t *testing.T, rand *mathrand.Rand) *coin.Transaction {
	var obj coin.Transaction
	err := encodertest.PopulateRandom(&obj, rand, encodertest.PopulateRandomOptions{
		MaxRandLen:    0,
		MinRandLen:    0,
...
func newRandomZeroLenNilTransactionForEncodeTest(t *testing.T, rand *mathrand.Rand) *coin.Transaction {
	var obj coin.Transaction
	err := encodertest.PopulateRandom(&obj, rand, encodertest.PopulateRandomOptions{
		MaxRandLen:    0,
		MinRandLen:    0,
...
func testLaqencoderTransaction(t *testing.T, obj *coin.Transaction) {
...
func TestLaqencoderTransaction(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))

	type testCase struct {
		name string
		obj  *coin.Transaction
	}
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderTransaction(t, tc.obj)
		})
	}
}
...
func testLaqencoderTransactionDecodeErrors(t *testing.T, k int, tag string, obj *coin.Transaction) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderTransactionDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderTransactionDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderTransactionDecodeErrors(t, i, "full", fullObj)
	}
}
