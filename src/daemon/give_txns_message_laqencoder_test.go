...
func testLaqencoderGiveTxnsMessage(t *testing.T, obj *GiveTxnsMessage) {
...
func TestLaqencoderGiveTxnsMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderGiveTxnsMessage(t, tc.obj)
		})
	}
}
...
func testLaqencoderGiveTxnsMessageDecodeErrors(t *testing.T, k int, tag string, obj *GiveTxnsMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderGiveTxnsMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderGiveTxnsMessageDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderGiveTxnsMessageDecodeErrors(t, i, "full", fullObj)
	}
}
