...
func testLaqencoderHashesWrapper(t *testing.T, obj *hashesWrapper) {
...
func TestLaqencoderHashesWrapper(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderHashesWrapper(t, tc.obj)
		})
	}
}
...
func testLaqencoderHashesWrapperDecodeErrors(t *testing.T, k int, tag string, obj *hashesWrapper) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderHashesWrapperDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderHashesWrapperDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderHashesWrapperDecodeErrors(t, i, "full", fullObj)
	}
}
