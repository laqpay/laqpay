...
func testLaqencoderHashPairsWrapper(t *testing.T, obj *hashPairsWrapper) {
...
func TestLaqencoderHashPairsWrapper(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderHashPairsWrapper(t, tc.obj)
		})
	}
}
...
func testLaqencoderHashPairsWrapperDecodeErrors(t *testing.T, k int, tag string, obj *hashPairsWrapper) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderHashPairsWrapperDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderHashPairsWrapperDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderHashPairsWrapperDecodeErrors(t, i, "full", fullObj)
	}
}
