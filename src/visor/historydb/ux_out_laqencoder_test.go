...
func newEmptyUxOutForEncodeTest() *UxOut {
	var obj UxOut
	return &obj
}

func newRandomUxOutForEncodeTest(t *testing.T, rand *mathrand.Rand) *UxOut {
	var obj UxOut
...
func newRandomZeroLenUxOutForEncodeTest(t *testing.T, rand *mathrand.Rand) *UxOut {
	var obj UxOut
	err := encodertest.PopulateRandom(&obj, rand, encodertest.PopulateRandomOptions{
		MaxRandLen:    0,
		MinRandLen:    0,
...
func newRandomZeroLenNilUxOutForEncodeTest(t *testing.T, rand *mathrand.Rand) *UxOut {
	var obj UxOut
	err := encodertest.PopulateRandom(&obj, rand, encodertest.PopulateRandomOptions{
		MaxRandLen:    0,
		MinRandLen:    0,
...
func testLaqencoderUxOut(t *testing.T, obj *UxOut) {
...
func TestLaqencoderUxOut(t *testing.T) {
...
func testLaqencoderUxOutDecodeErrors(t *testing.T, k int, tag string, obj *UxOut) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderUxOutDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderUxOutDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderUxOutDecodeErrors(t, i, "full", fullObj)
	}
}
