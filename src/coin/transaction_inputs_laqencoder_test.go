...
func testLaqencoderTransactionInputs(t *testing.T, obj *transactionInputs) {
...
func TestLaqencoderTransactionInputs(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderTransactionInputs(t, tc.obj)
		})
	}
}
...
func testLaqencoderTransactionInputsDecodeErrors(t *testing.T, k int, tag string, obj *transactionInputs) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderTransactionInputsDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderTransactionInputsDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderTransactionInputsDecodeErrors(t, i, "full", fullObj)
	}
}
