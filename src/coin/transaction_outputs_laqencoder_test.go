...
func testLaqencoderTransactionOutputs(t *testing.T, obj *transactionOutputs) {
...
func TestLaqencoderTransactionOutputs(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderTransactionOutputs(t, tc.obj)
		})
	}
}
...
func testLaqencoderTransactionOutputsDecodeErrors(t *testing.T, k int, tag string, obj *transactionOutputs) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderTransactionOutputsDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderTransactionOutputsDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderTransactionOutputsDecodeErrors(t, i, "full", fullObj)
	}
}
