...
//go:generate laqencoder -struct Transaction -unexported
//go:generate laqencoder -struct transactionInputs
//go:generate laqencoder -struct transactionOutputs
