...
func walletCreateCmd() *cobra.Command {
	...
	walletCreateCmd.Flags().Uint32P("bip44-coin", "", uint32(bip44.CoinTypeLaqpay), "BIP44 coin type")
	walletCreateCmd.Flags().StringP("coin", "c", string(wallet.CoinTypeLaqpay), "Wallet address coin type (options: laqpay, bitcoin)")
