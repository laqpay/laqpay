...
func addressGenCmd() *cobra.Command {
	addressGenCmd := &cobra.Command{
		Short: "Generate laqpay or bitcoin addresses",
		Use:   "addressGen",
	...
	addressGenCmd.Flags().StringP("coin", "c", "laqpay", "Coin type. Must be laqpay or bitcoin. If bitcoin, secret keys are in Wallet Import Format instead of hex.")
