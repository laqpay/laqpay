...
// NodeConfig configures the default CLI options for the laqpay node.
// These parameters are loaded via cmd/laqpay/laqpay.go into src/laqpay/laqpay.go.
type NodeConfig struct {
	...
	// GenesisAddressStr is the laqpay address that the genesis coins were sent to in the genesis block
	...
	// DisplayName is the display name of the coin in the wallet e.g. Laqpay
	DisplayName string `mapstructure:"display_name"`
	// Ticker is the coin's price ticker, e.g. LAQ
