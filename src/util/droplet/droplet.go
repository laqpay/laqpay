...
A droplet is the smallest possible coin amount in Laqpay, equal to 1/1000000 of a whole laqpay.
*/
package droplet
...
import (
	...
	logging "github.com/laqpay/laqpay/src/util/logging"
)
...
// FromString converts a laqpay balance string with decimal places to uint64 droplets.
...
func FromString(b string) (uint64, error) {
	...
	// Laqpays have a maximum of 6 decimal places
...
// ToString converts droplets to a laqpay balance fixed-point decimal string.
