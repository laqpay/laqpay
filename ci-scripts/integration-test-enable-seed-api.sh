#!/bin/bash
# Runs "enable-seed-api"-mode tests against a laqpay node configured with -enable-seed-api=true
...
LAQPAY_INTEGRATION_TESTS=1 LAQPAY_INTEGRATION_TEST_MODE=$MODE LAQPAY_NODE_HOST=$HOST WALLET_DIR=$WALLET_DIR \
...
# LAQPAY_INTEGRATION_TESTS=1 LAQPAY_INTEGRATION_TEST_MODE=$MODE RPC_ADDR=$RPC_ADDR \
