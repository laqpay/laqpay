#!/bin/bash
# Runs "disable-wallet-api"-mode tests against a laqpay node configured with the wallet API disabled.
...
LAQPAY_INTEGRATION_TESTS=1 LAQPAY_INTEGRATION_TEST_MODE=$MODE LAQPAY_NODE_HOST=$HOST API_WALLET_DIR=$WALLET_DIR \
